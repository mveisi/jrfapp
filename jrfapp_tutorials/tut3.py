...
jrfapp_stobj_file_name = jrfapp_stobj.save_file(file_name='real_data_cad_p_gs_bf_inv.bin')
#%%
...
jrfapp_stobj_file_name = jrfapp_stobj.save_file(file_name='real_data_cad_p_gs_af_inv.bin')
#%%
